...
Insert into DJANGO.CORE_CATEGORIA (IDCATEGORIA,NOMBRECATEGORIA) values ('2','Juguetes');
...
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('5','admin','0003_logentry_add_action_flag_choices',to_timestamp('02/07/22 21:19:42,031660000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('6','contenttypes','0002_remove_content_type_name',to_timestamp('02/07/22 21:19:42,403749000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('7','auth','0002_alter_permission_name_max_length',to_timestamp('02/07/22 21:19:42,451759000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('8','auth','0003_alter_user_email_max_length',to_timestamp('02/07/22 21:19:42,474765000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('9','auth','0004_alter_user_username_opts',to_timestamp('02/07/22 21:19:42,492770000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('10','auth','0005_alter_user_last_login_null',to_timestamp('02/07/22 21:19:42,523775000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('11','auth','0006_require_contenttypes_0002',to_timestamp('02/07/22 21:19:42,537779000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('12','auth','0007_alter_validators_add_error_messages',to_timestamp('02/07/22 21:19:42,557783000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('13','auth','0008_alter_user_username_max_length',to_timestamp('02/07/22 21:19:42,584789000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('14','auth','0009_alter_user_last_name_max_length',to_timestamp('02/07/22 21:19:42,610796000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('15','auth','0010_alter_group_name_max_length',to_timestamp('02/07/22 21:19:42,639802000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('16','auth','0011_update_proxy_permissions',to_timestamp('02/07/22 21:19:42,658806000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('17','auth','0012_alter_user_first_name_max_length',to_timestamp('02/07/22 21:19:42,682812000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('18','core','0001_initial',to_timestamp('02/07/22 21:19:42,733823000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('19','core','0002_alter_categoria_idcategoria_and_more',to_timestamp('02/07/22 21:19:42,764830000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('20','core','0003_rename_vehiculo_producto',to_timestamp('02/07/22 21:19:42,837846000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('21','core','0004_rename_patente_producto_codigo_and_more',to_timestamp('02/07/22 21:19:42,993880000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('22','core','0005_producto_descuento_producto_precio',to_timestamp('02/07/22 21:19:43,023888000','DD/MM/RR HH24:MI:SSXFF'));
Insert into DJANGO.DJANGO_MIGRATIONS (ID,APP,NAME,APPLIED) values ('23','sessions','0001_initial',to_timestamp('02/07/22 21:19:43,054895000','DD/MM/RR HH24:MI:SSXFF'));
REM INSERTING into DJANGO.DJANGO_SESSION
SET DEFINE OFF;
Insert into DJANGO.DJANGO_SESSION (SESSION_KEY,EXPIRE_DATE) values ('it5mst7e14p65odx58clr8ccljt6jl0e',to_timestamp('17/07/22 02:58:13,022588000','DD/MM/RR HH24:MI:SSXFF'));
--------------------------------------------------------
